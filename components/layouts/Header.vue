      ...
      >
        <div class="flex items-center justify-start w-1/4 h-full pr-4">
          ...
          >
            ...
            >
              <img
                src="/sink.png" class="w-full h-full rounded-full"
              >
            </span>
            <span class="mx-2">V2F</span>
          </a>
        </div>
        ...
        >
          ...
          >
            <a
              href="/" class="inline-flex items-center w-auto h-16 px-4 text-xl font-black leading-none text-gray-900 dark:text-gray-100 md:hidden"
            >
              <span
